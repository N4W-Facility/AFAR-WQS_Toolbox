%% Functional Branch
function [  FuncNetwork , PoNet] =  FunctionalBranch( obj, ReachID_RM, ReachID_RM_i, CurrID, PoNet)                                             
% -------------------------------------------------------------------------
% Matlab-R2023b
% -------------------------------------------------------------------------
%                              INFORMATION 
...
% Current ReachID
CurrentID           = ReachID_RM;
% Position of the Current ReachID
Posi                = find(obj.ReachID == CurrentID);
% Position Network
PoNet(Posi)         = 1;
% Branch Number
NumBranch           = 1;
...
while (NumBranch == 1)
    ...
    elseif (NumBranch > 1  || ~isempty(Posi1)) || (NumBranch == 1  || isempty(Posi1))
        for i = 1:NumBranch 
            ...
            New_ReachID_RM = obj.ReachID(Posi(i));
            
            %% Functional Branch
            [FuncNetwork_i,...
            PoNet] = ...
            obj.FunctionalBranch(New_ReachID_RM,...                    
                                    ReachID_RM_i,...
                                    CurrIDOut,...                                     
                                    PoNet);
